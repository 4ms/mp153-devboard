...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PeriphClkInit.Adc1ClockSelection = RCC_ADC1CLKSOURCE_PLL4;
    ...
    PC2     ------> ADC1_INP15
    */
    GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_3|GPIO_PIN_0
                          |GPIO_PIN_2|GPIO_PIN_5|GPIO_PIN_1|GPIO_PIN_4;
  ...
  */
    ...
    PeriphClkInit.Adc2ClockSelection = RCC_ADC2CLKSOURCE_PLL4;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC2     ------> ADC1_INP15
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_3|GPIO_PIN_0
                          |GPIO_PIN_2|GPIO_PIN_5|GPIO_PIN_1|GPIO_PIN_4);

    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_2);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PeriphClkInit.I2c3ClockSelection = RCC_I2C3CLKSOURCE_PCLK6;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
  ...
  */
    ...
    PeriphClkInit.I2c5ClockSelection = RCC_I2C5CLKSOURCE_PCLK6;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF13_QUADSPI;
    HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* hxspi)
{
  if(hxspi->Instance==QUADSPI)
  {
    ...
    PF9     ------> QUADSPI_BK1_IO1
    */
    HAL_GPIO_DeInit(GPIOF, GPIO_PIN_8|GPIO_PIN_6|GPIO_PIN_10|GPIO_PIN_9);
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  */
    ...
    PeriphClkInit.Sdmmc1ClockSelection = RCC_SDMMC1CLKSOURCE_HCLK6;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI3)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOF, GPIO_PIN_3|GPIO_PIN_1);
...
/* SAI1 */
    ...
    PH12     ------> SAI1_SCK_A
    */
    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_0|GPIO_PIN_6);
